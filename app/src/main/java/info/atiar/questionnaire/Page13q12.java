...
public class Page13q12 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page13q12);
               ...
               /* //save drawing
                ...
                if(imgSaved!=null){
                    ...
                    Toast unsavedToast = Toast.makeText(getApplicationContext(),
                            "Oops! Drawing could not be saved.", Toast.LENGTH_SHORT);
                    unsavedToast.show();
                }
                ...
                String path = SP.storeImage(getApplicationContext(), bmp, Info.fileNam_page13q12_image);
                SP.setPreference(getApplicationContext(),Info.key_page13q12_image,path);
                next();
