...
public class Page10q8 extends AppCompatActivity implements View.OnClickListener{
    private final String TAG = "drawing p10q8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page10q8);
    ...
    private void showSavePaintingConfirmationDialog(){
        ...
        saveDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener(){
            public void onClick(DialogInterface dialog, int which){
                ...
                String path = SP.storeImage(getApplicationContext(), bmp, Info.fileNam_page10q8_image);
                SP.setPreference(getApplicationContext(),Info.key_page10q8_image,path);
                next();
